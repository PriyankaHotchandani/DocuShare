...
import esign from 'assets/images/p-esign.png';
...
const data = [
  {
    ...
    icon: esign,
    title: 'E-Signature',
    description: `A easy and secured way to transfer your documents for Signings. Accept,view or Reject documents with an ease`,
  },
  {
    id: 2,
    icon: marksheet,
    title: 'Marksheet',
    description: `Mark your spreadsheets and share with your team for a easy and secure way of collaboration with assigned roles`,
  },
];
